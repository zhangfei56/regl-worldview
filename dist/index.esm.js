...
import React__default, { useState, useCallback, useEffect, memo, Fragment, useContext, useDebugValue } from 'react';
...
const targetHeadingSelector = createSelector(targetOrientationSelector, targetOrientation => {
  const out = vec3.transformQuat(TEMP_VEC3, UNIT_X_VECTOR$1, targetOrientation);
...
const positionSelector = createSelector(thetaOffsetSelector, phiSelector, distanceSelector, (thetaOffset, phi, distance) => {
...
const viewSelector = createSelector(stateSelector, orientationSelector, positionSelector, ({
  target,
  targetOffset,
  targetOrientation,
  perspective
  ...
  mat4.multiply(m, m, mat4.fromQuat(TEMP_MAT$1, quat.invert(TEMP_QUAT$1, orientation))); // 4. move camera to the origin
  ...
  mat4.multiply(m, m, mat4.fromQuat(TEMP_MAT$1, targetOrientation)); // 1. move target to the origin

  mat4.translate(m, m, vec3.negate(TEMP_VEC3, target)); // if using orthographic camera ensure the distance from "ground"
  ...
  if (!perspective) {
    ...
    TEMP_VEC3[1] = 0;
    TEMP_VEC3[2] = -2500;
    vec3.transformMat4(TEMP_VEC3, TEMP_VEC3, mat4.fromQuat(TEMP_MAT$1, quat.invert(TEMP_QUAT$1, targetOrientation)));
...
const billboardRotation = createSelector(orientationSelector, targetHeadingSelector, (orientation, targetHeading) => {
  ...
  mat4.multiply(m, m, mat4.fromQuat(TEMP_MAT$1, orientation));
  return m;
});
var selectors = {
...
//  Copyright (c) 2018-present, GM Cruise LLC
// $FlowFixMe
var WorldviewReactContext = /*#__PURE__*/React__default.createContext(undefined);
...
class Command extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement(WorldviewReactContext.Consumer, null, ctx => {
      if (ctx) {
        this.context = ctx;
      }
...
class WorldviewBase extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "_canvas", /*#__PURE__*/React.createRef());

    _defineProperty(this, "_cameraListener", /*#__PURE__*/React.createRef());
    ...
    _defineProperty(this, "_handleContextLost", ev => {
      const {
        width,
        height,
        top,
    ...
    _defineProperty(this, "_handleContextRestored", ev => {
  ...
  render() {
    ...
    const canvasHtml = canvas ? null : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("canvas", {
      style: {
        width,
        height,
        maxWidth: "100%",
    ...
    }, isFixedCamera ? canvasHtml : /*#__PURE__*/React.createElement(CameraListener, {
      cameraStore: worldviewContext.cameraStore,
      keyMap: keyMap,
      shiftKeys: shiftKeys,
      ref: el => this._cameraListener.current = el
    }, canvasHtml), worldviewContext.initializedData && /*#__PURE__*/React.createElement(WorldviewReactContext.Provider, {
...
const Worldview = /*#__PURE__*/React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Dimensions, null, ({
  width,
  height,
  left,
  top
}) => /*#__PURE__*/React.createElement(WorldviewBase, _extends({
  width: width,
  height: height,
  left: left,
  top: top,
...
function Cylinders(props) {
  return /*#__PURE__*/React.createElement(Command, _extends({
...
function Arrows(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Fragment, null, /*#__PURE__*/React__default.createElement(Cylinders, _extends({
    getChildrenForHitmap: getChildrenForHitmapWithOriginalMarker
  }, passedProps), cylinders), /*#__PURE__*/React__default.createElement(Cones, _extends({
    getChildrenForHitmap: getChildrenForHitmapWithOriginalMarker
  }, passedProps), cones));
}

var Arrows$1 = /*#__PURE__*/memo(Arrows);
...
class Axes extends React__default.Component {
  render() {
    return /*#__PURE__*/React__default.createElement(Lines, null, this.props.children);
  }
...
class PolygonLines extends React__default.Component {
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(Lines, {
...
class PolygonPoints extends React__default.Component {
  render() {
    ...
    return /*#__PURE__*/React__default.createElement(Spheres, {
...
function DrawPolygons({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(PolygonLines, null, polygons), /*#__PURE__*/React__default.createElement(PolygonPoints, null, polygons));
}
...
function FilledPolygons(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Triangles, _extends({
    getChildrenForHitmap: getChildrenForHitmapWithOriginalMarker
  }, rest), triangles);
}
...
class TextElement {
  ...
  constructor() {
    ...
    _defineProperty(this, "_prevTextColor", DEFAULT_TEXT_COLOR);
...
class Text extends React__default.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_textContainerRef", /*#__PURE__*/React__default.createRef());
  ...
  render() {
    ...
    }), /*#__PURE__*/React__default.createElement(WorldviewReactContext.Consumer, null, ctx => {
      if (ctx) {
        this._context = ctx;
      }
...
function GLText(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Command, _extends({
...
const drawModel = regl => {
  ...
  const withContext = regl({
    context: {
      poseMatrix: (context, props) => mat4.fromRotationTranslationScale(mat4.create(), orientationToVec4(props.pose.orientation), pointToVec3$1(props.pose.position), props.scale ? pointToVec3$1(props.scale) : [1, 1, 1]),
...
function GLTFScene(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Command, _extends({}, rest, {
...
class Overlay extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(WorldviewReactContext.Consumer, null, ctx => {
      if (ctx) {
        this._context = ctx;
      }
...
export { Arrows$1 as Arrows, Axes, Bounds, CameraListener, CameraStore, Command, Cones, Cubes, Cylinders, DEFAULT_CAMERA_STATE, DrawPolygons, FilledPolygons, GLTFScene, GLText, Grid, Lines, WorldviewBase as OffscreenWorldview, Overlay, Points, Polygon, PolygonBuilder, PolygonPoint, Ray, SUPPORTED_MOUSE_EVENTS, Spheres, Text, Triangles, Worldview, WorldviewReactContext, blend, camera, selectors as cameraStateSelectors, colorBuffer, cones, createInstancedGetChildrenForHitmap, cubes, cylinders, Worldview as default, defaultBlend, defaultDepth, defaultReglBlend, defaultReglDepth, eulerFromQuaternion, fromGeometry, fromSpherical, getCSSColor, getChildrenForHitmapWithOriginalMarker, getIdFromColor, getIdFromPixel, getRayFromClick, getVertexColors, intToRGB, lines, makeArrowsCommand, makeFilledPolygonsCommand, makeGLTextCommand, makePointsCommand, makeTrianglesCommand, nonInstancedGetChildrenForHitmap, orientationToVec4, parseGLB, pointToVec3$1 as pointToVec3, pointToVec3Array, shouldConvert, spheres, toColor, toRGBA, vec3ToPoint, vec4ToOrientation, vec4ToRGBA, withPose };
